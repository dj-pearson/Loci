    ...
    Scaffold(
        ...
        Column(
            ...
            TierCard(
                ...
                isCurrentPlan = currentTier == app.lociate.android.domain.model.SubscriptionTier.FREE,
                onSelect = {}
            )
            ...
            TierCard(
                ...
                isCurrentPlan = currentTier == app.lociate.android.domain.model.SubscriptionTier.PREMIUM,
                isRecommended = true,
                onSelect = {
            ...
            TierCard(
                ...
                isCurrentPlan = currentTier == app.lociate.android.domain.model.SubscriptionTier.FAMILY,
                onSelect = {
                    (context as? Activity)?.let { activity ->
